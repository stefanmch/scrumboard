...
describe('AuthController', () => {
  ...
  describe('register', () => {
    ...
    it('should register a new user successfully', async () => {
      ...
      const result = await controller.register(registerDto, '127.0.0.1', 'Mozilla/5.0');
  ...
  describe('refresh', () => {
    ...
    it('should refresh tokens successfully', async () => {
      ...
      const result = await controller.refresh(refreshTokenDto, '127.0.0.1', 'Mozilla/5.0');
  ...
  describe('logout', () => {
    ...
    it('should handle logout errors', async () => {
      ...
      await expect(controller.logout(mockUser)).rejects.toThrow(UnauthorizedException);
    });
  });
  ...
  describe('resetPassword', () => {
    ...
    it('should validate new password strength', async () => {
      ...
      await expect(controller.resetPassword(weakPasswordDto)).rejects.toThrow(BadRequestException);
    });
  });
  ...
  describe('revokeSession', () => {
    ...
    it('should handle unauthorized session revocation', async () => {
      mockAuthService.revokeSession.mockRejectedValue(
        new ForbiddenException('Cannot revoke session that does not belong to you')
      );
