...
describe('SimpleJwtAuthGuard', () => {
  ...
  beforeEach(async () => {
    ...
    jwtService = module.get<SimpleJwtService>(
      SimpleJwtService
    ) as jest.Mocked<SimpleJwtService>
  ...
  describe('canActivate', () => {
    ...
    describe('Edge Cases', () => {
      ...
      it('should handle tokens with special characters', async () => {
        reflector.getAllAndOverride.mockReturnValue(false)
        const specialToken =
          'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiYWRtaW4iOnRydWUsImp0aSI6ImY2MzliNDM1LTU4YzEtNGZhZi1hNzg0LTNmOGQzMWM0MzNlZSIsImlhdCI6MTU4Mjg4NTIzNSwiZXhwIjoxNTgyODg4ODM1fQ.validation-signature'
